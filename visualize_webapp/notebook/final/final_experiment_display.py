...
def rename_experiments_for_labels(exp_name: str, labels: ExperimentDisplayLabels) -> str:
	...
	# --- Legacy ids: pretrain_shuffle_mislabel_* (before scoring_helpers regex narrowed) ---
	...
	# --- Other legacy schedules (avoid matching pretrain_shuffle_mislabel) ---
